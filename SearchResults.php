<?php
    ...
    if(mysqli_num_rows($result)> 0){
        ...
        $TITLE="PRODUCTS RELATED TO YOUR SEARCH (".$RESULTS.")";
    }
    else{
        $TITLE="NO PROUCTS FOUND!";
    }
    $conn->close();
?>
<html>
    ...
    <body>
        <div class="container">  
                ...
                <div class="MainContent">
                        ...
                        <div class="ORDER-BY">
                                <form action="SearchResults.php?Search=<?php echo $Search?>" method="POST" target="_self">
                                        <select name="sort">
                                ...
                                <div class="card-container">
                                        ...
                                        if(isset($_POST['sort'])){
                                                ...
                                                if($sortby=='DEFAULT'){
                                                    ...
                                                    $sql = "SELECT * FROM products WHERE productname LIKE '%$Search%' ORDER BY price ASC";
                                                }
                                                else if($sortby== "PriceDecrease"){
                                                    $sql = "SELECT * FROM products WHERE productname LIKE '%$Search%' ORDER BY price DESC";
                                                }
                                                else if( $sortby== "AlphabeticalIncrease"){
                                                    $sql = "SELECT * FROM products WHERE productname LIKE '%$Search%' ORDER BY productname ASC";
                                                }
                                                else if( $sortby== "AlphabeticalDecrease"){
                                                    $sql = "SELECT * FROM products WHERE productname LIKE '%$Search%' ORDER BY productname DESC";
                                                }
                                                        ...
                                                        while ($row=mysqli_fetch_assoc($result)) {
                                                              ...
                                                              <div class="card">
                                                                        <a class="anchor" href="ViewProduct.php?id=<?php echo $row['id']?>">
                                                                                ...
                                                                                <div class="card-price" style="color:red"><?php echo $AFTERDISCOUNT?></div>
                                                                                <?php }else{ ?>
                                                                                        <div class="card-price"><?php echo $row['price']; ?> EGP</div>
                                                                                <?php }?>
