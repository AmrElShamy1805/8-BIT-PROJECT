    ...
    <div class="container">
        ...
        <div class="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li> 
                    <strong class="anchor">Console</strong>
                </li>
            </ul>
        </div>
        <div class="maincontent">
            <div class="my-product-title">
                <h1>
                    <span class="anchor">CONSOLES</span>
                </h1>
            </div>
            <div class="ORDER-BY">
                <form action="ViewConsoles.php" method="POST" target="_self">
                    <select name="sort">
            ...
            <?php
                ...
                if(isset($_POST['sort'])){
                    ...
                    if($sortby=='DEFAULT'){
                        ...
                        $sql = "SELECT * FROM products WHERE category='Console' ORDER BY price ASC";
                    }
                    else if($sortby== "PriceDecrease"){
                        $sql = "SELECT * FROM products WHERE category='Console' ORDER BY price DESC";
                    }
                    else if( $sortby== "AlphabeticalIncrease"){
                        $sql = "SELECT * FROM products WHERE category='Console' ORDER BY productname ASC";
                    }
                    else if( $sortby== "AlphabeticalDecrease"){
                        $sql = "SELECT * FROM products WHERE category='Console' ORDER BY productname DESC";
                    }
                }
                else{
                    $sql = "SELECT * FROM products WHERE category='Console'";
