    ...
    <div class="container">
        ...
        <div class="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li> 
                    <strong class="anchor">Accessories</strong>
                </li>
            </ul>
        </div>
        <div class="maincontent">
            <div class="my-product-title">
                <h1>
                    <span class="anchor">ACCESSORIES</span>
                </h1>
            </div>
            <div class="ORDER-BY">
                <form action="ViewAccessories.php" method="POST" target="_self">
                    <select name="sort">
            ...
            <?php
                ...
                if(isset($_POST['sort'])){
                    ...
                    if($sortby=='DEFAULT'){
                        ...
                        $sql = "SELECT * FROM products WHERE category='Accessories' ORDER BY productname ASC";
                    }
                    else if( $sortby== "AlphabeticalDecrease"){
                        $sql = "SELECT * FROM products WHERE category='Accessories' ORDER BY productname DESC";
                    }
