    ...
    <div class="container">
        ...
        <div class="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li> 
                    <strong class="anchor">Computer</strong>
                </li>
            </ul>
        </div>
        <div class="maincontent">
            <div class="my-product-title">
                <h1>
                    <span class="anchor">COMPUTERS</span>
                </h1>
            </div>
            <div class="ORDER-BY">
                <form action="ViewComputer.php" method="POST" target="_self">
                    <select name="sort">
            ...
            <?php
                ...
                if(isset($_POST['sort'])){
                    ...
                    if($sortby=='DEFAULT'){
                        ...
                        $sql = "SELECT * FROM products WHERE category='Computer' ORDER BY price ASC";
                    }
                    else if($sortby== "PriceDecrease"){
                        $sql = "SELECT * FROM products WHERE category='Computer' ORDER BY price DESC";
                    }
                    else if( $sortby== "AlphabeticalIncrease"){
                        $sql = "SELECT * FROM products WHERE category='Computer' ORDER BY productname ASC";
                    }
                    else if( $sortby== "AlphabeticalDecrease"){
                        $sql = "SELECT * FROM products WHERE category='Computer' ORDER BY productname DESC";
                    }
